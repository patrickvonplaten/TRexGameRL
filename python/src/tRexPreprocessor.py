...
class Prepocessor(object):
    ...
    def _process(self, image):
        image_cropped = self.crop_image(image)
        image_black_white = self.transform_image_to_black_white(image_cropped)
        image_resized = imresize(image_black_white, (self.resize, self.resize, 1))
