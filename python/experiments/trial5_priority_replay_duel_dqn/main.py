...
PATH_TO_MODELS = '/u/platen/TRexGameRL/python/experiments/trial5_priority_replay_duel_dqn/models'
PATH_TO_LOG = '/u/platen/TRexGameRL/python/experiments/trial5_priority_replay_duel_dqn/log'
