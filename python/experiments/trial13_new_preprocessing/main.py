...
PATH_TO_MODELS = '/u/platen/TRexGameRL/python/experiments/trial13_new_preprocessing/models'
PATH_TO_LOG = '/u/platen/TRexGameRL/python/experiments/trial13_new_preprocessing/log'
