...
PATH_TO_MODELS = '/u/platen/TRexGameRL/python/experiments/trial2_std_dqn_20000/models'
PATH_TO_LOG = '/u/platen/TRexGameRL/python/experiments/trial2_std_dqn_20000/log'
...
network = Model(inputs=input_shape, outputs=create_standard_dqn())
