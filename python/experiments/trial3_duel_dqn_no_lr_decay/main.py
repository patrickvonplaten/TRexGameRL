...
PATH_TO_MODELS = '/u/platen/TRexGameRL/python/experiments/trial3_duel_dqn_no_lr_decay/models'
PATH_TO_LOG = '/u/platen/TRexGameRL/python/experiments/trial3_duel_dqn_no_lr_decay/log'
