...
PATH_TO_MODELS = '/u/platen/TRexGameRL/python/experiments/trial12_init_small_eps_rms_prop/models'
PATH_TO_LOG = '/u/platen/TRexGameRL/python/experiments/trial12_init_small_eps_rms_prop/log'
