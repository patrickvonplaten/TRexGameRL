...
PATH_TO_MODELS = '/u/platen/TRexGameRL/python/experiments/trial8_init_small_epsilon/models'
PATH_TO_LOG = '/u/platen/TRexGameRL/python/experiments/trial8_init_small_epsilon/log'
