...
PATH_TO_MODELS = '/u/platen/TRexGameRL/python/experiments/trial6_higher_clipped_priority_duel_dqn/models'
PATH_TO_LOG = '/u/platen/TRexGameRL/python/experiments/trial6_higher_clipped_priority_duel_dqn/log'
