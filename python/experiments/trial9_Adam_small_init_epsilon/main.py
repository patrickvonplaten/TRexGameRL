...
PATH_TO_MODELS = '/u/platen/TRexGameRL/python/experiments/trial9_Adam_small_init_epsilon/models'
PATH_TO_LOG = '/u/platen/TRexGameRL/python/experiments/trial9_Adam_small_init_epsilon/log'
...
#        'optimizer': RMSprop(lr=0.00025, rho=0.9, epsilon=None, decay=0),
        'optimizer': Adam(lr=0.00025, beta_1=0.9, beta_2=0.999, epsilon=None, decay=0.01, amsgrad=False),
        'run_reward': 1,
        'jump_reward': -1,
        'duck_reward': 0,
        'crash_reward': -100
