...
PATH_TO_MODELS = '/u/platen/TRexGameRL/python/experiments/trial11_no_priority_experience_replay/models'
PATH_TO_LOG = '/u/platen/TRexGameRL/python/experiments/trial11_no_priority_experience_replay/log'
...
def create_config(is_priority_experience_replay=True):
    config = {
        ...
        'optimizer': RMSprop(lr=0.00025, rho=0.9, epsilon=None, decay=0.01),
        'run_reward': 1,
        'jump_reward': -3,
        'duck_reward': 0,
        'crash_reward': -100
...
if __name__ == "__main__":
    ...
    config = create_config(is_priority_experience_replay=False)
