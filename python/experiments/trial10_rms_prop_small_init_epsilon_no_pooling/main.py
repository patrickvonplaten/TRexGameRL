...
PATH_TO_MODELS = '/u/platen/TRexGameRL/python/experiments/trial10_rms_prop_small_init_epsilon_no_pooling/models'
PATH_TO_LOG = '/u/platen/TRexGameRL/python/experiments/trial10_rms_prop_small_init_epsilon_no_pooling/log'
